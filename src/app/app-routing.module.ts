...
const routes: Routes = [{
  ...
  {
    path: 'parcelle-info',
    loadChildren: () => import('./parcelle-info/parcelle-info.module').then( m => m.ParcelleInfoPageModule)
  },
  {
    path: 'parcelle-apex',
    loadChildren: () => import('./parcelle-apex/parcelle-apex.module').then( m => m.ParcelleApexPageModule)
  },
  {
    path: 'parcelle-input',
